...
public class SedanCarBuilder implements CarBuilder {
	...
	public void buildBodyStyle() {
		car.bodyStyle = "External dimensions: overall length (inches): 202.9, overall width (inches): 76.2, "
				+ "overall height (inches): 60.7, wheelbase (inches): 112.9, front track (inches): 65.3,"
				+ "real track (inches): 65.5 and curb to curb turning circle (feet): 39.5";
	}
